...
/**
 * Home-screen widget (large): current prayer + next prayer + live countdown.
 * Data computed natively from saved prayer times — no Flutter dependency.
 */
class PrayerWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        private const val TAG = "WidgetLarge"
        ...
        @JvmStatic
        fun updateData(context: Context, next: String, remaining: String) {
            refresh(context)
        }
        ...
        private fun setViews(context: Context, mgr: AppWidgetManager, widgetId: Int) {
            ...
            views.setTextViewText(R.id.widget_current_name, currentName)
            ...
            // Safe countdown: manual text instead of unreliable Chronometer
